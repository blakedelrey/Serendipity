...
class linkedListIterator
{
	...
	//Overload the equality operator. //Postcondition: Returns true if this iterator is equal to // the iterator specified by right, // otherwise it returns false.
...
public:
	...
	// empty. //Postcondition: If the list is empty, the program
...
private:
	...
	//Function to make a copy of otherList. //Postcondition: A copy of otherList is created and // assigned to this list. };
